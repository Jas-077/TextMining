...
def detect_sensitive_info(text):
    ...
    if credit_card_numbers is None: 
        credit_card_numbers =[]
    ...
    results = {
        ...
        "NRIC Numbers": nric_numbers,
        "Bank Account Numbers": bank_account_numbers,
        "Email Addresses": email_addresses,
        "Pincodes": pincodes,
        "Credit Card Numbers": credit_card_numbers,
        "CVV": cvvs,
    }
